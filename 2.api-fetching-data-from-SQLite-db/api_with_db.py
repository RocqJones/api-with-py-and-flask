...
"""
    The database downloaded for this lesson has 67 entries
...
def api_filter():
    ...
    # Query: remove the trail ' AND' and cap the query with the ';' as required at the end of all SQL statements
    query = query[:-4] + ';'
